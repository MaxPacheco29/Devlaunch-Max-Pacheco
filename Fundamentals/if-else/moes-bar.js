...
Verificación de Edad: Se utiliza un if-else para determinar si la persona cumple con la edad legal para beber (18 años o más) y 
se imprime el mensaje correspondiente.Este programa permite que el proceso de verificación de edad sea automático y preciso, 
asegurando que solo los mayores de edad puedan ingresar al bar.Puedes guiarte con esto:
