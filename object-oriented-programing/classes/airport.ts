/*
El objetivo es crear una clase Airport que modele las características y operaciones de un aeropuerto de forma más avanzada.
...
Crea una instancia en la clase Airport y demuestra el uso de estos metodos con distintas operaciones.
*/
...
class Airport {
    ...
    emergencyLanding(): void {
        ...
        console.log(`Aterrizaje de emergencia en el aeropuerto ${this._name}. La pista esta cerrada y el nivel de traffico es alto`)
...
const myAirport = new Airport ("Aeropuerto internacional", "Ciudad Quesada")
